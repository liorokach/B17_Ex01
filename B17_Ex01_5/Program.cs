namespace B17_Ex01_5
{
     public class Program
     {
          ...
          {
               System.Console.WriteLine(string.Format("The maximum digit in the number is {0} and the minimum digit is {1}.", maxDigVal, minDigVal));
               System.Console.WriteLine(string.Format("The number of digits above the unity is {0} and {1} is below the unity.", aboveUnityDig, belowUnityDig));
          }
